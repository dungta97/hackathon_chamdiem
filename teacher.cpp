...
Mat teacher::getAnswerSheet(){
    ...
    obj_corners[0] = cvPoint(0, 0); obj_corners[1] = cvPoint(sampleSheet.cols, 0);
    obj_corners[2] = cvPoint(sampleSheet.cols, sampleSheet.rows); obj_corners[3] = cvPoint(0, sampleSheet.rows);
